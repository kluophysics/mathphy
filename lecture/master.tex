...
\ctexset{
	...
	subsubsection={
        ...
        number = 第\arabic{subsubsection}条,
		% name = {},
		% beforeskip = 1.0ex plus 0.2ex minus .2ex,
		% afterskip = 1.0ex plus 0.2ex minus .2ex,
...
% \newpage
% \end{enumerate}
% \include{prerequiste.tex}

% \def\input@path{{./chap01/}}

% \include{chap01.tex}
% \include{complex_function.tex}
...
\subimport{chap03/}{chap03.tex}
\subimport{chap04/}{chap04.tex}
\subimport{chap05/}{chap05.tex}

% \part{数学物理方程}

\subimport{chap06/}{chap06.tex}
