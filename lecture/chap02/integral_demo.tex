...
$$
\begin{aligned}
\left|\int_{C_R} \frac{e^{\imath 2^2}}{2 \mathrm{iz}^2} d z\right| & =\left|\int_{C_R} \frac{e^{-R^2 \sin 2 \varphi+\imath^2 \cos 2 \varphi}}{2 \imath R^2 e^{\imath 2 \varphi}} R e^{\imath \varphi} \mathrm{id} \varphi\right| \\
